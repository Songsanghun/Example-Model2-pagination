...
<div id="header" class="width_full_size position_fix;" style="height:120px;">
	...
	<ul class="gnb width_full_size text_center" style="color:black; font-size: 15px; height: 38%">
		...
		<li><a href="bbs_list.html" class="text_no_underline">자유게시판</a></li>
...
<table class="table_default margin_center text_center" style="width:50%; height:180px; margin-top:30px">
	<tr>
		<th class="text_center" style="width:4%; vertical-align:middle;">NO</th>
		<th class="text_center" style="width:60%; vertical-align:middle;">제목</th>
		<th class="text_center" style="width:15%; vertical-align:middle;">작성자</th>
		<th class="text_center" style="width:15%; vertical-align:middle;">작성일</th>
		<th class="text_center" style="width:6%; vertical-align:middle;">조회수</th>
	</tr>
	<tr>
		<td>100</td>
		<td>title_001</td>
