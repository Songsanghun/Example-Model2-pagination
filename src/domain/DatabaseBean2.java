...
public class DatabaseBean2 {
	...
	public DatabaseBean2( String driver,String url,String username,String password) {
		this.driver = driver;
		this.url = url;
	...
	public Connection getConnection() {
		...
		try{
			...
			connection =DriverManager.getConnection(Database.ORACLE_URL,  //Shallow copy 를 썻다. new 써도 의미없다.
